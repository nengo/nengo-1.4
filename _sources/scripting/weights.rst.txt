...
We do this using the *weight_func* argument
...
We can also adjust these weights
...
from a normal distribution of standard deviation 0.001::
...
find all the small weights in the *w* matrix
