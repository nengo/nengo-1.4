...
.. java:type::  class DataPath

   Describes how to build a folder structure for a wrapped data node when it is being exported
...
.. java:constructor:: public DataPath(DataTreeNode dataNode, Collection<String> position)
   :outertype: DataPath
...
.. java:method:: public DataTreeNode getDataNode()
   :outertype: DataPath

getPath
^^^^^^^

.. java:method:: public Collection<String> getPath()
   :outertype: DataPath
