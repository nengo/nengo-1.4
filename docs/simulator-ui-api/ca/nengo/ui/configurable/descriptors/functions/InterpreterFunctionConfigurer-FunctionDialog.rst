...
InterpreterFunctionConfigurer.FunctionDialog
============================================

.. java:package:: ca.nengo.ui.configurable.descriptors.functions
   :noindex:

.. java:type::  class FunctionDialog extends ConfigDialog
   :outertype: InterpreterFunctionConfigurer

   This config dialog contains additional elements for configuring registered functions
...
.. java:constructor:: public FunctionDialog(UserConfigurer configManager, Dialog owner)
...
.. java:method:: @Override protected void initPanelBottom(JPanel panel)
   :outertype: InterpreterFunctionConfigurer.FunctionDialog
