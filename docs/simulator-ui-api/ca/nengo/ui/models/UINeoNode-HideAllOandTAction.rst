...
UINeoNode.HideAllOandTAction
============================

.. java:package:: ca.nengo.ui.models
   :noindex:

.. java:type::  class HideAllOandTAction extends StandardAction
   :outertype: UINeoNode
...
.. java:constructor:: public HideAllOandTAction(String actionName)
   :outertype: UINeoNode.HideAllOandTAction
