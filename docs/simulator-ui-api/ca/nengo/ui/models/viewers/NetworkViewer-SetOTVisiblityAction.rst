...
NetworkViewer.SetOTVisiblityAction
==================================

.. java:package:: ca.nengo.ui.models.viewers
   :noindex:

.. java:type::  class SetOTVisiblityAction extends StandardAction
...
Constructors
------------
SetOTVisiblityAction
^^^^^^^^^^^^^^^^^^^^

.. java:constructor:: public SetOTVisiblityAction(String actionName, boolean visible)
   :outertype: NetworkViewer.SetOTVisiblityAction
