...
AppFrame.HideDebugMemory
========================

.. java:package:: ca.nengo.ui.lib
   :noindex:

.. java:type::  class HideDebugMemory extends StandardAction
   :outertype: AppFrame
...
.. java:constructor:: public HideDebugMemory()
   :outertype: AppFrame.HideDebugMemory
