...
public class CanonicalModelTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.dynamics.impl.CanonicalModel.getRealization(float[], float[], float)'
	 */
	...
	/*
	 * Test method for 'ca.neo.dynamics.impl.CanonicalModel.isControllableCanonical(LTISystem)'
	 */
	...
	/*
	 * Test method for 'ca.neo.dynamics.impl.CanonicalModel.changeTimeConstant(LTISystem, float)'
	 */
