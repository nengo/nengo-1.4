...
public class PolynomialTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.Polynomial.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.Polynomial.map(float[])'
	 */
	public void testMap() {
	...
	/*
	 * Test method for 'ca.neo.math.impl.Polynomial.multiMap(float[][])'
	 */
