...
public class GaussianPDFTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.GaussianPDF.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.GaussianPDF.map(float[])'
	 */
	public void testMap() {
...
//		try { Thread.sleep(1000*10); } catch (InterruptedException e) {}
	...
	/*
	 * Test method for 'ca.neo.math.impl.GaussianPDF.multiMap(float[][])'
	 */
