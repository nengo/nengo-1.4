...
public class IdentityFunctionTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.IdentityFunction.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.IdentityFunction.map(float[])'
	 */
	public void testMap() {
		IdentityFunction f = new IdentityFunction(3, 0);
	...
	/*
	 * Test method for 'ca.neo.math.impl.IdentityFunction.multiMap(float[][])'
	 */
