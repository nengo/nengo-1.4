...
public class SineFunctionTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.SineFunction.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.SineFunction.getOmega()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.SineFunction.map(float[])'
	 */
	public void testMap() {
		SineFunction f = new SineFunction(0.5f);
	...
	/*
	 * Test method for 'ca.neo.math.impl.SineFunction.multiMap(float[][])'
	 */
