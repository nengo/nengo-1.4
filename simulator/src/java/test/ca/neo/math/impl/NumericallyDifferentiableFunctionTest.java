...
public class NumericallyDifferentiableFunctionTest extends TestCase {

	/*
	 * Test method for 'ca.neo.math.impl.NumericallyDifferentiableFunction.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.NumericallyDifferentiableFunction.map(float[])'
	 */
	public void testMap() {
		SigmoidFunction f = new SigmoidFunction();
		NumericallyDifferentiableFunction wrap = new NumericallyDifferentiableFunction(f, 0, 0.1f);
	...
	/*
	 * Test method for 'ca.neo.math.impl.NumericallyDifferentiableFunction.multiMap(float[][])'
	 */
	...
	/*
	 * 	Test method for 'ca.neo.math.impl.NumericallyDifferentiableFunction.getDerivative()'
	 */
