...
public class SigmoidFunctionTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.SigmoidFunction.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.SigmoidFunction.map(float[])'
	 */
	public void testMap() {
		SigmoidFunction f = new SigmoidFunction();
	...
	/*
	 * Test method for 'ca.neo.math.impl.SigmoidFunction.multiMap(float[][])'
	 */
	...
	/*
	 * 	Test method for 'ca.neo.math.impl.SigmoidFunction.getDerivative()'
	 */
