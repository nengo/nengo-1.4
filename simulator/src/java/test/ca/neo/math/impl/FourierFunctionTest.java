...
public class FourierFunctionTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.FourierFunction.FourierFunction(float[], float[], float[])'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.FourierFunction.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.FourierFunction.multiMap(float[][])'
	 */
