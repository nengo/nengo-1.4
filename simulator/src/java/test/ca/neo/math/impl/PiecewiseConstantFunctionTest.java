...
public class PiecewiseConstantFunctionTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.PiecewiseConstantFunction.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.PiecewiseConstantFunction.map(float[])'
	 */
	public void testMap() {
		PiecewiseConstantFunction f = new PiecewiseConstantFunction(new float[]{-1,0,1}, new float[]{.1f,.2f,.3f,.4f});
	...
	/*
	 * Test method for 'ca.neo.math.impl.PiecewiseConstantFunction.multiMap(float[][])'
	 */
