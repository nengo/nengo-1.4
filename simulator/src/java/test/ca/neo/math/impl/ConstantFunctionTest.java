...
public class ConstantFunctionTest extends TestCase {
	...
	/*
	 * Test method for 'ca.neo.math.impl.ConstantFunction.getDimension()'
	 */
	...
	/*
	 * Test method for 'ca.neo.math.impl.ConstantFunction.map(float[])'
	 */
	public void testMap() {
		ConstantFunction f = new ConstantFunction(1, 1f);
	...
	/*
	 * Test method for 'ca.neo.math.impl.ConstantFunction.multiMap(float[][])'
	 */
