...
/**Initially, spikes should be generated without any sort of random distribution, eventually this may change								  */
/**Modified version of LIFSpikeGenerator, original code taken from other SpikeGenerator classes written by @author: Bryan Tripp						  */
...
public class RateFunctionSpikeGenerator implements SpikeGenerator {
	 ...
	 */
	/*public RateFunctionSpikeGenerator {
	...
	public static class PoiraziDendriteSigmoidFactory implements SpikeGeneratorFactory
	{
		...
		public PoiraziDendriteSigmoidFactory()
		{
			//no values need to be intialized
		}
