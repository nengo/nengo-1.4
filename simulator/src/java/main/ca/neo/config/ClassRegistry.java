...
public class ClassRegistry {
	...
	public static final String TYPES_LOCATION_PROPERTY = "ca.neo.config.types";
	public static final String IMPLS_LOCATION_PROPERTY = "ca.neo.config.implementations";
	...
	private ClassRegistry() {
		...
		String[] types = loadList(System.getProperty(TYPES_LOCATION_PROPERTY, "ca/neo/config/types.txt"));
		...
		String[] impls = loadList(System.getProperty(IMPLS_LOCATION_PROPERTY, "ca/neo/config/impls.txt"));
	...
	private static String[] loadList(String resource) {
		...
		try {
			BufferedReader reader = new BufferedReader(
					new InputStreamReader(ClassLoader.getSystemResourceAsStream(resource)));
