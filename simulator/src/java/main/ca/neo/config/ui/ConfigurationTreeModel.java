...
import ca.neo.model.neuron.impl.HodgkinHuxleySpikeGenerator;
...
import ca.neo.model.plasticity.impl.RealPlasticityRule;
...
//			configurable.addTermination("composite", MU.zero(100, 1), .005f, false);
			...
			SpikingNeuron n = new SpikingNeuron(new LinearSynapticIntegrator(), sg, 1, 0, "test");
			Object configurable = new SpikeGeneratorOrigin(n, sg);
