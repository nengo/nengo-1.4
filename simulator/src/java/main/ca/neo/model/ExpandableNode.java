 ...
 * Note that a given Node might provide methods for adding Terminations if more customization 
 * is needed. 
 *  
 * @author Bryan Tripp
 */
public interface ExpandableNode extends Node {
	...
	/**
	 * Adds a new Termination into this Node. 
	 *  
	 * @param name Unique name for this Termination (in the scope of this Node)
	 ...
	 * @param tauPSC Time constant with which inputcoming signals are filtered. All Terminations have  
