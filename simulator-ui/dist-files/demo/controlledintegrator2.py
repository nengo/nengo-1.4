...
net = nef.Network('Controlled integrator 2')
...
# Create a controllable input function with starting value of 0
net.make_input('control', [0])
...
def feedback(x):
    # Different than the other controlled integrator
    return x[0] * x[1] + x[0]
