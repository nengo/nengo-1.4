...
The Original Code is "PNodeFactory.java". Description:
""
...
/**
 * Configures a node factory.
 * 
 * Used for configuring the neuron type for an NEFEnsemble
 * 
 * @author Shu Wu
 */
public class PNodeFactory extends Property {
    ...
    public PNodeFactory(String name, String description) {
    ...
    @Override public Class<NodeFactory> getTypeClass() {
