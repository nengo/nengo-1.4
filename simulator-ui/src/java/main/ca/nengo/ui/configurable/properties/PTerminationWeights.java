...
The Original Code is "PTerminationWeights.java". Description:
...
public class PTerminationWeights extends Property {
    ...
    public PTerminationWeights(String name, String description, int dimensions) {
        super(name, description, null);
        this.ensembleDimensions = dimensions;
    }

    @Override protected TerminationWeightsInputPanel createInputPanel() {
