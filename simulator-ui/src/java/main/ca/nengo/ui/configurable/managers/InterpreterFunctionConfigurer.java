 ...
 * @author Shu Wu
 */
public class InterpreterFunctionConfigurer extends UserConfigurer {
    ...
    @Override protected ConfigDialog createConfigDialog() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    PString pFnName = new PString("Name",
                    		"Name to assign to this function", "MyFunc");
                    PFunction pFunction = new PFunction("New Function",
                    		"The base function to be extended", null, 1);
                ...
                if (functionName != null) {
                    ...
                    if (function != null) {
                        PlotFunctionAction action = new PlotFunctionAction(
                        		"Function preview", function, FunctionDialog.this);
                        action.doAction();
